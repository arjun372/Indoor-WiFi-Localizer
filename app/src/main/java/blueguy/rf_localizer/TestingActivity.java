...
public class TestingActivity extends AppCompatActivity {
    ...
    public static final String TAG_ACTIVITY = "TestingActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get Toolbar
        Toolbar mToolbar = (Toolbar) findViewById(R.id.testing_toolbar);
        setSupportActionBar(mToolbar);

        // Get ListView
        mListView = (ListView) findViewById(R.id.testing_ListView_data);
...
//            Toast.makeText(TestingActivity.this, "getting data", Toast.LENGTH_SHORT).show();
...
//            }
    ...
    ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            Toast.makeText(TestingActivity.this, "Service connected", Toast.LENGTH_SHORT).show();
        ...
        public void onServiceDisconnected(ComponentName name) {
            Toast.makeText(TestingActivity.this, "Service disconnected", Toast.LENGTH_SHORT).show();
            mBounded = false;
            mScanService = null;
        }
    };
